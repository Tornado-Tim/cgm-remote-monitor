...
daytoday.html = function html(client) {
  ...
  var ret =
    ...
    + translate('Display') + ': '
    + '<input type="checkbox" id="rp_optionsinsulin" checked><span style="color:white;opacity:0.75">'+translate('Insulin')+'</span>'
    + '<input type="checkbox" id="rp_optionscarbs" checked><span style="color:yellow;opacity:0.75">'+translate('Carbs')+'</span>'
    + '<input type="checkbox" id="rp_optionsbasal" checked><span style="color:#aee7fd;opacity:0.75">'+translate('Basal rate')+'</span>'
    ...
    + '<input type="checkbox" id="rp_optionsiob"><span style="color:white;opacity:0.75">'+translate('IOB')+'</span>'
    + '<input type="checkbox" id="rp_optionscob"><span style="color:yellow;opacity:0.75">'+translate('COB')+'</span>'
    + '<input type="checkbox" id="rp_optionsopenaps"><span style="color:sienna;opacity:0.75">'+translate('OpenAPS')+'</span>'
    + '<input type="checkbox" id="rp_optionsdistribution"><span style="color:white;opacity:0.75">'+translate('Insulin distribution')+'</span>'
    + '&nbsp;'+translate('Size')
    + ' <select id="rp_size">'
    ...
    + '  <option x="1875" y="750">1875x750px</option>'
    + '</select>'
    + '<br>'
    + translate('Scale') + ': '
    ...
    function prepareContextCircles(sel) {
      ...
      sel.attr('cx', function (d) {
        return xScale2(d.date) + padding.left;
          ...
          .style('opacity', function () { return 0.75 })
...
//            .text((t.percent ? (t.percent > 0 ? '+' : '') + t.percent + '%' : '') + (t.absolute ? Number(t.absolute).toFixed(2) + 'U' : ''));
    ...
    if (options.insulindistribution) {
      var boluscolor = 'white';
      var basalcolor = '#aee7fd';
      ...
      var carbscolor = d3.scale.ordinal().range(['yellow']);
