...
daytoday.html = function html(client) {
  ...
  var ret =
    ...
    + '<input type="checkbox" id="rp_optionscarbs" checked><span style="color:red;opacity:0.75">'+translate('Carbs')+'</span>'
    ...
    + '<input type="checkbox" id="rp_optionscob"><span style="color:red;opacity:0.75">'+translate('COB')+'</span>'
