...
daytoday.html = function html(client) {
  ...
  var ret =
    ...
    + translate('Display') + ': '
    + '<input type="checkbox" id="rp_optionsinsulin" checked><span style="color:blue;opacity:0.75">'+translate('Insulin')+'</span>'
    ...
    + '<input type="checkbox" id="rp_optionsiob"><span style="color:blue;opacity:0.75">'+translate('IOB')+'</span>'
    ...
    + '<input type="checkbox" id="rp_optionsdistribution"><span style="color:blue;opacity:0.75">'+translate('Insulin distribution')+'</span>'
    + '&nbsp;'+translate('Size')
    + ' <select id="rp_size">'
