...
// clears the current user brush and resets to the current real time data
  ...
  function sgvToColor(sgv) {
    ...
    if (client.settings.theme !== 'default') {
      if (sgv > (client.settings.thresholds.bgHigh*1.100)) {
        color = '#e3b4f3';
        ...
        color = 'yellow';
      } else if (sgv >= (client.settings.thresholds.bgTargetBottom*1.25) && sgv <= (client.settings.thresholds.bgTargetTop/1.25) && client.settings.theme === 'colors') {
        color = '#3fce02';
