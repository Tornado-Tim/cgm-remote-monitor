...
// clears the current user brush and resets to the current real time data
  ...
  function sgvToColor(sgv) {
    ...
    if (client.settings.theme !== 'default') {
      if (sgv > (client.settings.thresholds.bgHigh*2)) {
        color = '#e3b4f3';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.90)) {
        color = '#D6A7E6';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.80)) {
        color = '#b800f5';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.70)) {
        color = '#d452ff';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.60)) {
        color = '#fd20d7';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.50)) {
        color = '#ee59d5';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.40)) {
        color = '#f38ee2';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.30)) {
        color = '#f44496';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.20)) {
        color = '#f76767';
      } else if (sgv > (client.settings.thresholds.bgHigh*1.10)) {
        color = '#f93434';
      } else if (sgv > client.settings.thresholds.bgHigh) {
        color = 'red';
      } else if (sgv > (client.settings.thresholds.bgTargetTop*1.25)) {
        color = 'orange';
      } else if (sgv > client.settings.thresholds.bgTargetTop*1.18) {
        color = '#ffbf00';
      } else if (sgv > client.settings.thresholds.bgTargetTop*1.10) {
        color = 'yellow';
      } else if (sgv > client.settings.thresholds.bgTargetTop) {
        color = '#dbef02';
      } else if (sgv >= (client.settings.thresholds.bgTargetBottom*1.25) && sgv <= (client.settings.thresholds.bgTargetTop/1.10) && client.settings.theme === 'colors') {
        color = '#3fce02';
